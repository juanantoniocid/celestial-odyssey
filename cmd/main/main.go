...
func main() {
	...
	systemInputHandler := systems.NewInputHandler()

	levels := level.LoadLevel1(player, character, renderer, inputHandler, collisionHandler, systemInputHandler)
